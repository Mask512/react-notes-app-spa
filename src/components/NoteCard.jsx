...
export default function NoteCard({
  ...
  return (
    <div className="group flex-1 relative min-w-72  overflow-hidden bg-white px-6 py-8 shadow-xl ring-1 ring-gray-900/5 transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl sm:max-w-full lg:max-w-[352px] rounded-md sm:px-10">
      ...
      <div className="relative z-10 mx-auto max-w-md">
        <div className="space-y-4 pt-5 text-base leading-7 text-gray-600 transition-all duration-300 group-hover:text-white/90">
          <Link to={`/detail/${id}`}>
            <h4 className="text-2xl hover:text-blue-950">
              {title}
            </h4>
          </Link>
